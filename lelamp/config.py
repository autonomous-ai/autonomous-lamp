...
REALTIME_LAMP_MEMORY_MAX_CHARS: int = int(os.environ.get("LELAMP_REALTIME_LAMP_MEMORY_MAX_CHARS", "100000"))
REALTIME_MEMORY_MAX_CHARS: int = int(os.environ.get("LELAMP_REALTIME_MEMORY_MAX_CHARS", "100000"))
