...
FIRE_HAZARD_CONFIRM_S = float(os.environ.get("LELAMP_FIRE_HAZARD_CONFIRM_S", "5.0"))
FIRE_HAZARD_DEDUP_WINDOW_S = float(os.environ.get("LELAMP_FIRE_HAZARD_DEDUP_WINDOW_S", "30.0"))
